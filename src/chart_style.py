...
the others, the same rationale the vendored engines already document. This
repo is the canonical source for the shared core; if the palette changes,
update it here first and re-sync the rest.
"""
